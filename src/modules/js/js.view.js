...
const CATEGORIES = [
  {
    ...
    topics: [
      ...
      { id: 'introduccion-ejecucion',    label: 'Introducción: Ejecución',        icon: 'play-outline',               description: 'Cómo ejecuta JavaScript línea por línea y concepto de scope.' },
      ...
      { id: 'switch-case',               label: 'Switch case',                    icon: 'shuffle-outline',            description: 'Selección múltiple por casos usando una sola expresión.' },
      ...
      { id: 'json-localstorage',         label: 'JSON y localStorage',            icon: 'save-outline',               description: 'Persistencia de datos con JSON y almacén del navegador.' },
      ...
      { id: 'dom-basico',                label: 'DOM básico',                     icon: 'code-outline',               description: 'Seleccionar y manipular elementos del documento.' },
      { id: 'eventos-dom',               label: 'Eventos del DOM',                icon: 'hand-left-outline',          description: 'Escuchar y responder a acciones del usuario.' },
      { id: 'errores-try-catch',         label: 'Errores: try/catch/finally',     icon: 'bug-outline',                description: 'Manejo de excepciones para código robusto.' },
      ...
      { id: 'fechas-tiempo',             label: 'Fechas y tiempo',                icon: 'calendar-outline',           description: 'Trabajar con fechas y medir tiempo de ejecución.' },
      ...
      { id: 'funciones-variadicas', label: 'Funciones variadicas', icon: 'git-merge-outline', description: 'Rest parameters (...args) para aceptar número variable de argumentos.' },
      { id: 'generators',       label: 'Generators (function*)',    icon: 'flash-outline',            description: 'Funciones pausables con yield para generar valores bajo demanda.' },
      { id: 'iteradores',       label: 'Iteradores',               icon: 'swap-horizontal-outline',  description: 'Symbol.iterator y protocolos para iterar sobre objetos personalizados.' },
