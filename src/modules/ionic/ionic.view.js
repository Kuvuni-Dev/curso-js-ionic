...
const CATEGORIES = [
  ...
  },
  {
    ...
    components: [
      { id: 'ion-tabs',        label: 'ion-tabs',           icon: 'albums-outline',               description: 'Contenedor del sistema de pestañas.' },
      { id: 'ion-tabs',        label: 'ion-tab-bar',        icon: 'reorder-four-outline',         description: 'Barra inferior con los botones de pestaña.' },
      { id: 'ion-tabs',        label: 'ion-tab-button',     icon: 'apps-outline',                 description: 'Botón individual dentro de la tab bar.' },
      { id: 'ion-segment',     label: 'ion-segment',        icon: 'git-commit-outline',           description: 'Selector de opciones en línea (como pestañas superiores).' },
      { id: 'ion-segment',     label: 'ion-segment-button', icon: 'radio-button-on-outline',      description: 'Opción individual dentro de un ion-segment.' },
      { id: 'ion-breadcrumbs', label: 'ion-breadcrumb',     icon: 'return-up-forward-outline',    description: 'Ruta de migas de pan para orientación en profundidad.' },
      { id: 'ion-breadcrumbs', label: 'ion-breadcrumbs',    icon: 'git-merge-outline',            description: 'Contenedor de ion-breadcrumb con desbordamiento configurable.' },
      { id: 'ion-menu',        label: 'ion-menu',           icon: 'menu-outline',                 description: 'Menú lateral deslizable (drawer).' },
      { id: 'ion-menu',        label: 'ion-menu-button',    icon: 'menu-sharp',                   description: 'Botón que abre/cierra el ion-menu.' },
    ],
  },
  {
    ...
    components: [
      { id: 'ion-alert',        label: 'ion-alert',         icon: 'alert-circle-outline',    description: 'Cuadro de diálogo modal con botones.' },
      { id: 'ion-toast',        label: 'ion-toast',         icon: 'notifications-outline',   description: 'Notificación temporal no bloqueante.' },
      { id: 'ion-loading',      label: 'ion-loading',       icon: 'hourglass-outline',       description: 'Indicador de carga con overlay.' },
      { id: 'ion-modal',        label: 'ion-modal',         icon: 'browsers-outline',        description: 'Ventana modal que cubre la pantalla.' },
      { id: 'ion-modal',        label: 'ion-popover',       icon: 'chatbox-outline',         description: 'Capa flotante anclada a un elemento.' },
      { id: 'ion-spinner',      label: 'ion-spinner',       icon: 'sync-outline',            description: 'Animación de carga con varios estilos.' },
      { id: 'ion-spinner',      label: 'ion-skeleton-text', icon: 'text-outline',            description: 'Placeholder animado mientras carga el contenido.' },
      { id: 'ion-progress-bar', label: 'ion-progress-bar',  icon: 'stats-chart-outline',     description: 'Barra de progreso determinada o indeterminada (también en Layout).' },
    ],
  },
];
